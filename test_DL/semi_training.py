...
trainset = CustomDataset(root='/tmp/wl2337/', split="newlyLabeled", transform=train_transform)
augset1 = CustomDataset(root='/tmp/wl2337/', split="newlyLabeled", transform=aug_transform1)
augset2 = CustomDataset(root='/tmp/wl2337/', split="newlyLabeled", transform=aug_transform2)
augset3 = CustomDataset(root='/tmp/wl2337/', split="newlyLabeled", transform=aug_transform3)
...
torch.save(net.state_dict(), os.path.join(args.checkpoint_dir, "net_demo_con.pth"))

print(f"Saved checkpoint to {os.path.join(args.checkpoint_dir, 'net_demo_con.pth')}")
